...
function FooterSection() {
  return (
    <>
    <Card style={{ position: 'fixed', left: 0, bottom: 0, width: '100%'}}>
            ...
            <div className="row">
              <div className="col-lg-4 col-6 d-flex flex-column justify-content-start order-1 order-lg-1">
                    <div className="text-start m-1">
                        <a href="#" className="text-dark text-decoration-none">Terms and conditions</a>
                    </div>
                    <div className="text-start m-1">
              ...
              <div className="col-lg-4  col-6  d-flex flex-column justify-content-end order-2 order-lg-3" >
                    <div className='text-end m-1'>
                        <a href="#" className="text-dark text-decoration-none fw-bold normal">Quick Links</a>
                    </div>
                    <div className="text-end m-1">
      ...
      <Card.Footer className="text-muted text-center fw-bold normal" style={{ backgroundColor: '#919391' }}>
